 ...
 */
@Entity
@Table(name = "aos_trust_tb")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AosTrustTb.findAll", query = "SELECT a FROM AosTrustTb a"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustIndex", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustIndex = :productMainTrustIndex"),
    @NamedQuery(name = "AosTrustTb.findByProductrMainTrustRefNo", query = "SELECT a FROM AosTrustTb a WHERE a.productrMainTrustRefNo = :productrMainTrustRefNo"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustName", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustName = :productMainTrustName"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustDob", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustDob = :productMainTrustDob"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustGender", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustGender = :productMainTrustGender"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustRelationship", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustRelationship = :productMainTrustRelationship"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustPercentage", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustPercentage = :productMainTrustPercentage"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustInputdate", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustInputdate = :productMainTrustInputdate"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustUserindex", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustUserindex = :productMainTrustUserindex"),
    @NamedQuery(name = "AosTrustTb.findByProductMainTrustMobileNo", query = "SELECT a FROM AosTrustTb a WHERE a.productMainTrustMobileNo = :productMainTrustMobileNo")})
public class AosTrustTb implements Serializable {
    ...
    public AosTrustTb(TrustTbModel aostrust) {
    ...
    public AosTrustTb(Integer productMainTrustIndex) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AosTrustTb)) {
            return false;
        }
        AosTrustTb other = (AosTrustTb) object;
    ...
    public String toString() {
        return "com.source1.entity.AosTrustTb[ productMainTrustIndex=" + productMainTrustIndex + " ]";
    }
