 ...
 */
@Entity
@Table(name = "eazyapp_depend_tb")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EazyappDependTb.findAll", query = "SELECT e FROM EazyappDependTb e"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndIndex", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndIndex = :productMainDepndIndex"),
    @NamedQuery(name = "EazyappDependTb.findByProductrRefNo", query = "SELECT e FROM EazyappDependTb e WHERE e.productrRefNo = :productrRefNo"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndName", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndName = :productMainDepndName"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndDob", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndDob = :productMainDepndDob"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndGender", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndGender = :productMainDepndGender"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndMobileNo", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndMobileNo = :productMainDepndMobileNo"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndSumassured", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndSumassured = :productMainDepndSumassured"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndRelationship", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndRelationship = :productMainDepndRelationship"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndCategory", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndCategory = :productMainDepndCategory"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndInputdate", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndInputdate = :productMainDepndInputdate"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndUserindex", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndUserindex = :productMainDepndUserindex"),
    @NamedQuery(name = "EazyappDependTb.findByProductMainDepndPremium", query = "SELECT e FROM EazyappDependTb e WHERE e.productMainDepndPremium = :productMainDepndPremium")})
public class EazyappDependTb implements Serializable {
    ...
    public EazyappDependTb() {
    }
    
    public EazyappDependTb(EazyappDependTbModel eazyapp) {
        ...
        this.productMainDepndAddress = eazyapp.getProductMainDepndAddres();
    ...
    public EazyappDependTb(Integer productMainDepndIndex) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EazyappDependTb)) {
            return false;
        }
        EazyappDependTb other = (EazyappDependTb) object;
    ...
    public String toString() {
        return "com.source2.entity.EazyappDependTb[ productMainDepndIndex=" + productMainDepndIndex + " ]";
    }
