 ...
 */
@Entity
@Table(name = "eazylife_customer_tb")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EazylifeCustomerTb.findAll", query = "SELECT e FROM EazylifeCustomerTb e"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerindex", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerindex = :customerindex"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerRefNo", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerRefNo = :customerRefNo"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerRegistrationDate", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerRegistrationDate = :customerRegistrationDate"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerSurname", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerSurname = :customerSurname"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerMiddleName", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerMiddleName = :customerMiddleName"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerFirstname", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerFirstname = :customerFirstname"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerGender", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerGender = :customerGender"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerDateofbirth", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerDateofbirth = :customerDateofbirth"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerMaritalStatus", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerMaritalStatus = :customerMaritalStatus"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerMobile", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerMobile = :customerMobile"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerStatus", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerStatus = :customerStatus"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerEmail", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerEmail = :customerEmail"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerBranch", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerBranch = :customerBranch"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerUserindex", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerUserindex = :customerUserindex"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerInputdate", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerInputdate = :customerInputdate"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerIdCard", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerIdCard = :customerIdCard"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerIdCardNo", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerIdCardNo = :customerIdCardNo"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerTitle", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerTitle = :customerTitle"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerHomeTown", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerHomeTown = :customerHomeTown"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerPlaceOfBirth", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerPlaceOfBirth = :customerPlaceOfBirth"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerNationality", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerNationality = :customerNationality"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerEmployerName", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerEmployerName = :customerEmployerName"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerEmployerEmail", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerEmployerEmail = :customerEmployerEmail"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerEmployerTelNo", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerEmployerTelNo = :customerEmployerTelNo"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerTin", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerTin = :customerTin"),
    @NamedQuery(name = "EazylifeCustomerTb.findByCustomerMobileMoney", query = "SELECT e FROM EazylifeCustomerTb e WHERE e.customerMobileMoney = :customerMobileMoney")})
public class EazylifeCustomerTb implements Serializable {
    ...
    public EazylifeCustomerTb() {
    }
    
    public EazylifeCustomerTb(CustomerModel eazyl) {
    ...
    public EazylifeCustomerTb(Integer customerindex) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EazylifeCustomerTb)) {
            return false;
        }
        EazylifeCustomerTb other = (EazylifeCustomerTb) object;
    ...
    public String toString() {
        return "com.source3.entity.EazylifeCustomerTb[ customerindex=" + customerindex + " ]";
    }
